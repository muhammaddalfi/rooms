        ...
        return DataTables::of($olt)
            ...
            ->addColumn('action', function ($olt) {
                if(auth()->user()->can('olt edit')){
                    ...
                    <a href="javascript:void(0)" class="btn btn-outline-success btn-icon ml-2 map" data-id="' . $olt->lat .','. $olt->lng. '"><i class="ph-map-trifold"></i></a>';
                }
                 else if(auth()->user()->can('map view')){
