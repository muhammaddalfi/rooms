...
@section('content')
    @if (auth()->user()->can('read-dashboard-cluster') &&
            auth()->user()->can('read-dashboard-keluhan'))
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <table class="table datatable-perusahaan-admin">
                            <thead>
                                <th>Perusahaan</th>
                                <th>Jumlah</th>
                            </thead>
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <table class="table datatable-internal-admin">
                            <thead>
                                <th>PIC Internal</th>
                                <th>Jumlah</th>
                            </thead>
